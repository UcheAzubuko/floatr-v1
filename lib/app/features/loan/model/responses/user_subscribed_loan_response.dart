...
class UserSubscribedLoanResponse {
    ...
    factory UserSubscribedLoanResponse.fromRawJson(String str) => UserSubscribedLoanResponse.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UserSubscribedLoanResponse.fromJson(Map<String, dynamic> json) => UserSubscribedLoanResponse(
        ...
        paymentSchedules: List<dynamic>.from(json["paymentSchedules"].map((x) => x)),
...
class UserSubscribedLoanResponseBank {
    ...
    factory UserSubscribedLoanResponseBank.fromRawJson(String str) => UserSubscribedLoanResponseBank.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UserSubscribedLoanResponseBank.fromJson(Map<String, dynamic> json) => UserSubscribedLoanResponseBank(
        uniqueId: json["uniqueId"],
...
class BankBank {
    ...
    factory BankBank.fromRawJson(String str) => BankBank.fromJson(json.decode(str));
...
class UserSubscribedLoanResponseLoan {
    ...
    factory UserSubscribedLoanResponseLoan.fromRawJson(String str) => UserSubscribedLoanResponseLoan.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory UserSubscribedLoanResponseLoan.fromJson(Map<String, dynamic> json) => UserSubscribedLoanResponseLoan(
        uniqueId: json["uniqueId"],
        name: json["name"],
        minAmount: json["minAmount"],
        maxAmount: json["maxAmount"],
...
class MetaLoan {
    ...
    factory MetaLoan.fromRawJson(String str) => MetaLoan.fromJson(json.decode(str));
